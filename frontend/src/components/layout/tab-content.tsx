...
const NovncTab = lazy(() => import("#/routes/novnc-tab"));
...
export function TabContent({ conversationPath }: TabContentProps) {
  ...
  const isNovncActive = currentPath === `${conversationPath}/novnc`;
  ...
  return (
    <div className="h-full w-full relative">
      ...
      >
        ...
        <div
          className={`absolute inset-0 ${isNovncActive ? "block" : "hidden"}`}
        >
          <NovncTab />
        </div>
      </Suspense>
