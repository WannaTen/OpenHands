...
from openhands.agenthub.general_agent.tools.bash import create_cmd_run_tool
from openhands.agenthub.general_agent.tools.browser import BrowserTool
from openhands.agenthub.general_agent.tools.finish import FinishTool
from openhands.agenthub.general_agent.tools.ipython import IPythonTool
from openhands.agenthub.general_agent.tools.llm_based_edit import LLMBasedFileEditTool
from openhands.agenthub.general_agent.tools.str_replace_editor import (
...
class GeneralAgent(Agent):
    ...
    This agent implements the General Agent idea that consolidates LLM agents' **act**ions into a unified **code** action space for both *simplicity* and *performance* (see paper for more details).
