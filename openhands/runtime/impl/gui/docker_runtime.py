...
CONTAINER_NAME_PREFIX = 'openhands-gui-runtime-'
...
class GUIRuntime(ActionExecutionClient):
    """This runtime Gives the GUI interface to the user.
    ...
    def _attach_to_container(self):
        ...
        for port in self.container.attrs['NetworkSettings']['Ports']:  # type: ignore
            ...
            if port >= APP_PORT_RANGE_1[0] and port <= APP_PORT_RANGE_1[1]:
