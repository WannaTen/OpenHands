...
@app.get('/novnc-url')
async def get_novnc_url(conversation: ServerConversation = Depends(get_conversation)) -> JSONResponse:
    """Get the NoVNC URL.

    This endpoint allows getting the NoVNC URL.

    Args:
        conversation (ServerConversation): The conversation object obtained via dependency injection.
